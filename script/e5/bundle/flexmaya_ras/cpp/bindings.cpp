...
PYBIND11_MODULE(_flexmaya_ras, m) {
    ...
    m.def("build_trace_ras", &flexmaya::build_trace_ras, py::call_guard<py::gil_scoped_release>());
    m.def("build_deduplicated_trace_ras", &flexmaya::build_deduplicated_trace_ras, py::call_guard<py::gil_scoped_release>());
    m.def("build_rank_grouped_trace_ras", &flexmaya::build_rank_grouped_trace_ras, py::call_guard<py::gil_scoped_release>());
    m.def(
        "build_rank_grouped_selected_trace_ras",
        &flexmaya::build_rank_grouped_selected_trace_ras,
        py::call_guard<py::gil_scoped_release>());
    m.def("filter_trace_partitions", &flexmaya::filter_trace_partitions, py::call_guard<py::gil_scoped_release>());
